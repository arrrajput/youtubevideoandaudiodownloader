...
class Youtube:
    def __init__(self, window):
        self.window = window
        self.window.title('Abhi Rajput')
        self.window.geometry('500x420+300+50')
        self.window.resizable(False, False)
        self.window.config(bg = 'lemonchiffon2')
        
        title = Label(self.window, text = 'YouTube File Downloader', font = ('times new roman', 15), bg = '#262626', fg = 'white').pack(side = TOP, fill = X)
    ...
    def search(self):
        if self.var_url.get() == '':
            ...
            # To Convert Image URL into Image......
            ...
            # To Fetch File Size as per Type.....
